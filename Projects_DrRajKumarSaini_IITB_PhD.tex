...
%\begin{center}
%  \LARGE{\textbf{RAJ KUMAR SAINI}}
%  \end{center}  \\
%\vspace{-1ex}
%%%%%%%%%%%%%%%%%% CURRICULUM VITAE OF APPLICANT end %%%%%%%%%%%%%%%%%%%
%\hline 
%\normalsize
%%%%%%%%%%%%%%%%%%%%%%%%%%----------------------------------------%%%%%%%%%%%%%%%%%
%\vspace{-2ex}
...
%\vspace{-1ex}
%
%  \begin{minipage}{0.6\linewidth} %0.4
%    \centering\begin{tabular}{lcc}
%Department of Energy Science and Engineering  \\
%Indian Institute of Technology Bombay  \\
%Mumbai, Maharashtra (INDIA) - 400076    \\
%Email : \href{mailto:raj.km.saini@gmail.com}{\textbf{raj.km.saini@gmail.com}}  \\
%\hspace{0.46in}   \href{mailto:raj_km_saini@yahoo.com}{\textbf{raj\_km\_saini@yahoo.com}} \\
%Skype : {\textbf{\Absender}} \\
%Mobile : \textbf{\href{contact-primary:+919820699744}{+91 9820699744} } \\
%\hspace{0.48in}  \textbf{\href{contact-alternative:+919082609631}{+91 9082609631} }        
%    \end{tabular}
%  \end{minipage}%
%  %%%%%%%%%%%%%%%%%%%%%%%%
%  \hspace{0.13in}
%    {\begin{minipage}{0.4\linewidth}  %0.3
%    \centering\begin{tabular}{lcc}
%\textbf{Address for correspondence:}  \\
%MRSB (MANAS-QIP) - 607 \\ %C/o: Dr. Mahendra Singh Saini \\
%Opp. Vihar House\\ %316/1, New Adarsh Nagar \\
%IIT Bombay, Powai \\ %Roorkee, Haridwar \\
%Maharashtra- 400076\\ %Uttrakhand - 247667 \\
%%Mobile : \textbf{\href{contact-primary:+919719173505}{+919719173505} } \\
%~\\
%~\\  
%~\\      
%    \end{tabular}
...
%%    \hspace{0.1in}\centering\includegraphics[height=0.55\linewidth, width=.5\linewidth]{Photo_raj_kumar_saini1}
%%  \end{minipage}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
%\end{figure*}%
%%%%%%%%%%%%%%%%%%%%%%%%%%%------------------%%%%%%%%%%%%%%%%%%%%%%%%%
